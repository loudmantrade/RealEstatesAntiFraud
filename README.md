...
Создание надежной платформы для поиска недвижимости на рынках **Португалии** и **Украины**, которая:
...
- 📱 Facebook Marketplace (через плагины source + processing)
- 🏢 Крупные риелторские компании (например, IAT - через специализированные плагины)
...
*Source Plugins (интеграция источников данных):*
- 📱 **Facebook Marketplace Plugin** - сбор объявлений с Facebook Marketplace для Португалии и Украины
- 🏢 **IAT Real Estate Plugin** - интеграция с крупными риелторскими компаниями (IAT и аналогичные)
- 🌐 Дополнительные региональные платформы по мере расширения

*Processing Plugins (обработка специфичных источников):*
- Нормализация данных из Facebook Marketplace (специфичная структура данных)
- Обработка данных от риелторских компаний (структурированные API)
- Обогащение данных метаданными из профессиональных источников
...
- [ ] Facebook Marketplace source plugin
- [ ] Плагины для крупных риелторских компаний (IAT и другие)
- [ ] Admin dashboard
- [ ] API v1
